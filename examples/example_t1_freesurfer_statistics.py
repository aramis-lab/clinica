...
from clinica.pipeline.t1.t1_freesurfer import recon_all_statistics_pipeline
...
T1_recon_all_statistics = recon_all_statistics_pipeline(output_dir, tsv_file_CAPP, analysis_series_id = analysis_series_id, working_directory=working_directory)
