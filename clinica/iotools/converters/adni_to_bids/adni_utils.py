...
def write_adni_sessions_tsv(sessions_dict, fields_bids, bids_subjs_paths):
    ...
    for sp in bids_subjs_paths:
        ...
        if sessions_dict.has_key(bids_id):
            ...
            sessions_df['adas_memory'] = float(sessions_df['adas_Q1'] + sessions_df['adas_Q4'] + sessions_df['adas_Q7'] + sessions_df['adas_Q8'] + sessions_df['adas_Q9']) / 45
            sessions_df['adas_language'] = float(sessions_df['adas_Q2'] + sessions_df['adas_Q5'] + sessions_df['adas_Q10'] + sessions_df['adas_Q11'] + sessions_df['adas_Q12']) / 25
            sessions_df['adas_praxis'] = float(sessions_df['adas_Q3'] + sessions_df['adas_Q6']) / 10
            sessions_df['adas_concentration'] = float(sessions_df['adas_Q13']) / 5
