...
def create_file(image, modality, bids_dir, mod_to_update):
    ...
    modality_specific = {
        ...
        "fdg": {
            "output_path": "pet",
            "output_filename": "_trc-18FFDG_pet",
            "to_center": True,
            "json": "n",
        },
        "pib": {
            "output_path": "pet",
            "output_filename": "_trc-11CPIB_pet",
            "to_center": True,
            "json": "n",
        },
        "av45": {
            "output_path": "pet",
            "output_filename": "_trc-18FAV45_pet",
            "to_center": True,
            "json": "n",
        },
        "fbb": {
            "output_path": "pet",
            "output_filename": "_trc-18FFBB_pet",
            "to_center": True,
            "json": "n",
        },
        "tau": {
            "output_path": "pet",
            "output_filename": "_trc-18FAV1451_pet",
            "to_center": True,
            "json": "n",
        },
    }
