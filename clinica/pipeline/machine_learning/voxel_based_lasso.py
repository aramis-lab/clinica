...
from clinica.pipeline.machine_learning.voxel_based_io import get_caps_t1_list_OLD, load_data, revert_mask, weights_to_nifti, save_subjects_prediction, results_to_csv
