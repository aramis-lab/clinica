...
def write_statistics_per_subject(subject_id, analysis_series_id, output_dir):
    ...
    aparc_desikan_lh_volume = 'lh_' + subject_id + '_aparc_desikan_volume.tsv'
    aparc_desikan_rh_volume = 'rh_' + subject_id + '_aparc_desikan_volume.tsv'
    aparc_desikan_lh_thickness = 'lh_' + subject_id + '_aparc_desikan_thickness.tsv'
    aparc_desikan_rh_thickness = 'rh_' + subject_id + '_aparc_desikan_thickness.tsv'
    aparc_desikan_lh_area = 'lh_' + subject_id + '_aparc_desikan_area.tsv'
    aparc_desikan_rh_area = 'rh_' + subject_id + '_aparc_desikan_area.tsv'
    aparc_desikan_lh_meancurv = 'lh_' + subject_id + '_aparc_desikan_meancurv.tsv'
    aparc_desikan_rh_meancurv = 'rh_' + subject_id + '_aparc_desikan_meancurv.tsv'

    aparc_destrieux_lh_volume = 'lh_' + subject_id + '_aparc_destrieux_volume.tsv'
    aparc_destrieux_rh_volume = 'rh_' + subject_id + '_aparc_destrieux_volume.tsv'
    aparc_destrieux_lh_thickness = 'lh_' + subject_id + '_aparc_destrieux_thickness.tsv'
    aparc_destrieux_rh_thickness = 'rh_' + subject_id + '_aparc_destrieux_thickness.tsv'
    aparc_destrieux_lh_area = 'lh_' + subject_id + '_aparc_destrieux_area.tsv'
    aparc_destrieux_rh_area = 'rh_' + subject_id + '_aparc_destrieux_area.tsv'
    aparc_destrieux_lh_meancurv = 'lh_' + subject_id + '_aparc_destrieux_meancurv.tsv'
    aparc_destrieux_rh_meancurv = 'rh_' + subject_id + '_aparc_destrieux_meancurv.tsv'

    aparc_BA_lh_volume = 'lh_' + subject_id + '_aparc_BA_volume.tsv'
    aparc_BA_rh_volume = 'rh_' + subject_id + '_aparc_BA_volume.tsv'
    aparc_BA_lh_thickness = 'lh_' + subject_id + '_aparc_BA_thickness.tsv'
    aparc_BA_rh_thickness = 'rh_' + subject_id + '_aparc_BA_thickness.tsv'
    aparc_BA_lh_area = 'lh_' + subject_id + '_aparc_BA_area.tsv'
    aparc_BA_rh_area = 'rh_' + subject_id + '_aparc_BA_area.tsv'
    aparc_BA_lh_meancurv = 'lh_' + subject_id + '_aparc_BA_meancurv.tsv'
    aparc_BA_rh_meancurv = 'rh_' + subject_id + '_aparc_BA_meancurv.tsv'
