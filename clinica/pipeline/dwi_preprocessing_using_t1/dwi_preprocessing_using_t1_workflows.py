...
def susceptibility_distortion_correction_using_t1(name='susceptibility_distortion_correction_using_t1'):
    ...
    ants_registration_syn_quick = pe.Node(interface=niu.Function(
        ...
        function=utils.ants_registration_syn_quick), name='ants_registration_syn_quick')
    ...
    combin_warp = pe.Node(interface=niu.Function(
        ...
        function=utils.ants_combine_transform), name='combin_warp')
