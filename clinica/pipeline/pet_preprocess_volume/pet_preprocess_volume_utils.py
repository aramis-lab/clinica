...
def step1(in_hello_word):
    ...
    print(in_hello_word + " from the step 1 of the PET Preprocess Volume Clinica pipeline.")
...
def step2(in_hello_word):
    ...
    print(in_hello_word + " from the step 2 of the PET Preprocess Volume Clinica pipeline.")