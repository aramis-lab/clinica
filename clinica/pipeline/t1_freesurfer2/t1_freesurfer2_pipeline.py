"""T1 FreeSurfer2 - Clinica Pipeline.
...
class T1FreeSurfer2(cpe.Pipeline):
    """T1 FreeSurfer2 SHORT DESCRIPTION.
    ...
    Returns:
        A clinica pipeline object containing the T1 FreeSurfer2 pipeline.

    Raises:


    Example:
        >>> from t1_freesurfer2 import T1FreeSurfer2
    ...
    def get_input_fields(self):
        ...
        return ['recon_all_args'] # Fill here the list
    ...
    def get_output_fields(self):
        ...
        return ['subject_id'] # Fill here the list
    ...
    def build_core_nodes(self):
        ...
        import t1_freesurfer2_utils as utils
        import nipype.interfaces.utility as nutil
        import nipype.pipeline.engine as npe
        ...
        dataprepr = npe.Node(name='dataprepr',
                            interface=nutil.Function(
                                ...
                                output_names=['nouse0', 'nouse1', 'nouse2', 'nouse3', 'subject_dir', 'subject_id',
                                              'subject_list', 'session_list'],
                                function=utils.get_dirs_check_reconalled))
        dataprepr.inputs.output_dir = self.output_dir
        dataprepr.inputs.subjects_visits_tsv = self.tsv_file
        ...
        datagrabbernode.inputs.input_dir = self.input_dir
        ...
        tsvmapnode.inputs.output_dir = self.output_dir
        ...
        lognode.inputs.output_dir = self.output_dir
        ...
        self.connect([
            ...
            (dataprepr, recon_all, [('subject_dir', 'subjects_dir')]),
            (dataprepr, recon_all, [('subject_id', 'subject_id')]),
            (datagrabbernode, recon_all, [('anat_t1', 'T1_files')]),
            (datagrabbernode, flagnode, [('anat_t1', 't1_list')]),
            (dataprepr, lognode, [('subject_list', 'subject_list')]),
            (dataprepr, lognode, [('session_list', 'session_list')]),
