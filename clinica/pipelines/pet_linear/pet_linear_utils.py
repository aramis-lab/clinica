...
def step1(t1w, in_hello_word):
    ...
    cprint(in_hello_word + " from the step 1 of the pet_linear Clinica pipeline for" + t1w)
...
def step2(t1w, in_advanced_arg):
    ...
    cprint(in_advanced_arg + " arg from the step 2 of the pet_linear Clinica pipeline for" + t1w)