# `svm_regularization`` - <VERY_SHORT_DESCRIPTION>
...
```
clinica run svm_regularization bids_directory caps_directory
```
where:
...
!!! cite "Example of paragraph (short version):"
    These results have been obtained using the `svm_regularization` pipeline of Clinica. This pipeline is a ...

!!! cite "Example of paragraph (long version):"
    These results have been obtained using the `svm_regularization` pipeline of Clinica. More precisely,...
