...
def copy_and_rename_spm_output_files(
    ...
    spm_figures = rename_spm_figures(spm_mat, list_files, group_label)
    ...
    regression_coeff = rename_beta_files(spm_mat, list_files, covariates, class_names)
...
def rename_spm_figures(spm_mat: str, list_files: list, group_label: str) -> list:
