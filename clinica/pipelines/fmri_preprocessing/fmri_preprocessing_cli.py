...
class fMRIPreprocessingCLI(ce.CmdParser):
    ...
    def define_options(self):
        ...
        from .fmri_preprocessing_utils import get_pipeline_parameters
        ...
        optional.add_argument("-fwhm", "--full_width_at_half_maximum",
                              metavar="FWHM",
                              nargs=3, type=int, default=parameters['full_width_at_half_maximum'],
                              help="A list of integers specifying the full width at half maximum (FWHM) filter size "
                                   ...
                                   self.list_to_string(parameters['full_width_at_half_maximum']))
        optional.add_argument("-t1s", "--t1_native_space",
                              action='store_true', default=parameters['t1_native_space'],
        ...
        optional.add_argument("-fsbm", "--freesurfer_brain_mask",
                              action='store_true', default=parameters['freesurfer_brain_mask'],
        ...
        optional.add_argument("-u", "--unwarping",
                              action='store_true', default=parameters['unwarping'],
