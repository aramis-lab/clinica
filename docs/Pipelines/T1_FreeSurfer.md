...
## Outputs
Results are stored in the following folder of the [CAPS hierarchy](../../CAPS/Specifications/#t1-freesurfer-freesurfer-based-processing-of-t1-weighted-mr-images): `subjects/<participant_id>/ses-<session_id>/t1/freesurfer_cross_sectional`.
...
Among the files generated by FreeSurfer, you may be interested in the following outputs:
  ...
  (where `*` stands for `<participant_id>_ses-<session_id>`)
