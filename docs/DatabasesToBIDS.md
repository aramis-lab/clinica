...
Clinica provides tools to curate several publicly available neuroimaging datasets (currently ADNI, AIBL, NIFD and OASIS) and convert them to BIDS [[Samper-González et al., 2018](https://doi.org/10.1016/j.neuroimage.2018.08.042); [Wen et al., 2018](https://arxiv.org/abs/1812.11183)].
